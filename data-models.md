...
| 2026‑09 | Claude Fable 5.1 / Mythos 5.1 | Anthropic | Same weights; Fable GA, Mythos trusted‑access. Led AA Index v4.1.1 (65.7) and, briefly, HLE with tools |
| 2026‑09 | Kimi K2.8 Preview | Moonshot AI | Kimi Code workhorse; Moonshot says coding performance is close to K3 with more efficient thinking. No weights, no public score table |
| 2026‑09 | Claude Opus 5.5 | Anthropic | Fable‑5.1 level at 40% lower typical cost than Opus 5. Leads Terminal‑Bench 4.0 (66.4%) and HLE with tools (67.7%) |
...
| **Claude Opus 5.5** | **2026‑09‑22** | — | — | Less compute to serve than Opus 5 (Anthropic) | 1M in / 128K out | C | Anthropic launch table, max effort unless noted: **Terminal‑Bench 4.0 66.4%** (xhigh; Fable 5.1 55.8%, Astra 57.9% at high — effort levels differ), FrontierCode v1.1 Main 54.4% (54.6% at default medium), CursorBench 4.0 57.8% (52.5% at medium), **HLE with tools 67.7%** (Fable 5.1 65.6% in this later table), Terminal‑Bench Science 0.1 58.7% (Astra still leads at 64.6%), OSWorld 2.0 81.8% partial, Chartography 89.0% with tools, AutomationBench 40.0% (Astra 41.4%, Zapier). **GDPval‑AA v2.1: 1846 Elo** (Fable 5.1 1735, Opus 5 1708, Astra 1542). v2.1 is not the v2 board where Fable 5.1 posted 1853 | First model of the Claude 5.5 family, and the first release since Anthropic called for pacing the frontier. "At the level of Fable 5.1 on most work." $4/$20 per Mtok (20% below Opus 5); cache reads **$0.20** (60% below Opus 5); typical workloads ~40% cheaper; output >30% faster. Fast mode $8/$40 at up to 2.5×. Default effort is `medium`; adaptive thinking cannot be disabled. Knowledge cutoff June 2026. Pre‑release tests by METR and Frontier Design. Strongest score yet on Anthropic's automated behavioral audit. Safeguards match Fable 5.1 because Anthropic says it is comparable to Mythos 5.1 in biology and cybersecurity: Life Sciences Verification Program is open for Opus 5.5 now; Cyber Verification Program expands in the coming weeks. Internal HAProxy C→Rust rewrite: 9.5 hours vs 12 for Fable 5.1, 51% cheaper. Sonnet 5.5 and Haiku 5.5 "in the coming weeks." |

Notes: From Aug 14 Anthropic began watermarking Claude text output to comply with the EU AI Act's transparency code (in force Aug 2, ~190 signatories including all major Western labs). Fable 5.1 and Mythos 5.1 share weights; score gaps on Terminal‑Bench 4.0 are mostly the cyber safeguards firing. OpenAI's launch table and Anthropic's system card agree on Fable 5.1 Terminal‑Bench 4.0 at 55.8%; xAI's Grok 4.7 table lists Fable 5.1 at 57.9% on the same benchmark name — treat cross‑lab harnesses as not directly comparable. Opus 5.5's 66.4% on Terminal‑Bench 4.0 is at xhigh; Astra's 57.9% in that table is the high‑effort number OpenAI published. GDPval‑AA **v2.1** (Opus 5.5 launch) is a different board from **v2** (Fable 5.1 system card, 1853 Elo).
...
| **Kimi K2.8 Preview** | **2026‑09‑11** | undisclosed | — | — | **1M** (every Kimi Code membership tier) | C (hosted; weights not released) | No public score table. Moonshot: coding and agent performance **close to K3**, with more efficient thinking than K2.7‑Code | Rolled into Kimi Code on the existing `kimi-for-coding` id, so clients did not have to change configuration. Thinking levels match K3 (`low` / `high` / `max`, default `max`). With thinking off, both K3‑series and K2.8 requests are served by K2.8 Preview. A K3.1 has been teased in leaks; as of Sep 23 there is no model card, API id, price, or weights |
...
4. **Benchmark saturation**: MMLU and HumanEval are saturated. In September 2026, ARC‑AGI‑3 (7.8% → 99.9%), FrontierMath Tier 4 (→ 97.6%), and ARC‑AGI‑2 (→ 95%) joined them, all on OpenAI's GPT‑6 Astra launch table. What still discriminates: Terminal‑Bench 4.0 (Opus 5.5 66.4% at xhigh, Astra 57.9% at high, Fable 5.1 55.8%, Gemini 3.8 Flash 19.1%), Terminal‑Bench Science (Astra 64.6%, Opus 5.5 58.7%), Terminal‑Bench 3.0 (still ~35%), Humanity's Last Exam with tools (Opus 5.5 67.7%; Astra 57.2% on OpenAI's own table), SWE‑bench Pro, and long‑horizon professional work (GDPval‑AA v2.1: Opus 5.5 1846 Elo — a different board from v2). Artificial Analysis Intelligence Index **v4.1.1** is a new version — do not compare its 61–66 cluster to the older index numbers cited for July–August models.
...
- Anthropic: [News index](https://www.anthropic.com/news), [Fable 5.1 and Mythos 5.1](https://www.anthropic.com/claude-fable-and-mythos-5-1), [Opus 5.5](https://www.anthropic.com/claude-opus-5-5), [Models docs](https://docs.anthropic.com/en/docs/about-claude/models/whats-new-claude-4-5)
- Moonshot: [Kimi Code changelog (K2.8 Preview)](https://www.kimi.com/code/docs/en/kimi-code/whats-new.html)
...
_Compiled April 26, 2026; updated July 9, 2026; updated August 23, 2026; updated September 23, 2026 (GPT‑6 Astra, Claude Fable 5.1 / Mythos 5.1, Gemini 3.8 Flash + Flash Cyber, Muse Spark 1.3, Kimi K2.8 Preview, DeepSeek V4.1‑Flash, Grok 4.7, Claude Opus 5.5). Treat all undisclosed compute, parameter, and cost figures as approximate; mark them as such when citing._
