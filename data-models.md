# Frontier AI/LLM Model Releases — June 2020 to August 2026

A structured, sourced compilation of significant frontier model releases from GPT‑3 through August 23, 2026.
...
| 2026‑08 | GLM‑5.3 | Zhipu / Z.ai | Post‑training‑only upgrade tops GDPval‑AA v2 (1769 Elo); open‑source SOTA on Terminal‑Bench 3.0 |
...
| **Astra** (name confirmed; **unreleased**) | Named 2026‑08‑01; release TBD (final branding — GPT‑6 vs GPT‑5.7 vs standalone "Astra" — undecided per The Information) | — | — (new pretraining run, not a post‑train) | — | — | C | Aug 1 research post: an internal Astra version produced **ten new results on long‑standing open problems in mathematics and theoretical CS, each with a machine‑checkable Lean proof** | First frontier model credited with a body of new, formally verified mathematics. On Aug 7 OpenAI disclosed it "cannot rule out" Astra reaching the **Critical** cybersecurity threshold under its Preparedness Framework — the first OpenAI model to hit that designation — triggering strengthened controls before any release. Codex integration confirmed by an OpenAI employee Aug 17; launch rumored imminent |
...
Notes: Fable 5.1 is rumored (leaks Jul 26 claim it is finished internally) but unannounced as of Aug 23. From Aug 14 Anthropic began watermarking Claude text output to comply with the EU AI Act's transparency code (in force Aug 2, ~190 signatories including all major Western labs).
...
| **Gemini 3.5 Pro** | limited preview; **still not GA as of 2026‑08‑23** | — | — | — | 1M | C | — | Announced at I/O; repeatedly delayed — reporting cites coding/reliability problems; Flash line carries the brand in the meantime |
...
| **DeepSeek‑V4‑Flash‑Vision‑Exp** | 2026‑08‑21 | — | — | — | — | API (experimental) | — | First multimodal vision model in the V4 line |

Note: DeepSeek never shipped a model branded "R2" (still true as of August 2026 — Reuters reported Liang Wenfeng held it back over performance; some third‑party "R2 launch" posts in May 2026 are unreliable). V3.1 unified reasoning + non‑reasoning into one model, and the reasoning frontier is carried by V4‑Pro thinking mode. The hosted R1 endpoint retired July 24, 2026.
...
Corporate note: SpaceX absorbed xAI in a February 2026 all‑stock deal (~$1.25T combined) and rebranded the unit **SpaceXAI** in May 2026. SpaceX IPO'd on Nasdaq June 12 ($75B raised, largest ever). The ~$60B all‑stock Anysphere (Cursor) acquisition **closed August 14, 2026** — two days after Grok 4.6 launched — and Cursor introduced **Origin** (agent‑era code hosting, a GitHub rival) three days later. Grok Bot, a system for assigning ongoing tasks to persistent agents, launched Aug 11. Grok 5 (reportedly 6T‑parameter MoE) remains in training on Colossus 2 as of August 2026.
...
| **GLM‑5.3** | **2026‑08‑14** | Zhipu / Z.ai | same 744B/40B base as 5.2 — **all gains from post‑training** | 1M | API now; weights promised ~2 wks post‑launch | AA Index 60 (top open score); **GDPval‑AA v2 1769 Elo — beats Fable 5 (1743) and GPT‑5.6 Sol (1730)**; Terminal‑Bench 2.1 88.2; Terminal‑Bench 3.0 28.3 (open SOTA); DeepSWE 66.9 (up from 46.2); HLE w/ tools 62.5; CyberGym 84.5 (tops Mythos 5); "emergent cyber capabilities" per Z.ai's own framing |
...
7. **Government entered the release loop** (new in 2026): Anthropic's Fable 5 / Mythos 5 were suspended for 18 days under a first‑of‑its‑kind US export‑control directive (June 12–30); OpenAI's GPT‑5.6 launched first as a government‑coordinated limited preview; OpenAI disclosed Aug 7 that **Astra may have reached "Critical" cyber capability** — the first such designation — delaying release; the White House accused Moonshot of distilling Kimi K3 from Fable 5, with Treasury threatening sanctions; and the **EU AI Act's transparency code took effect Aug 2**, pushing ~190 signatories (Anthropic first, Aug 14) to watermark AI‑generated text. Frontier cyber capability is now a deployment gate, with "trusted access" programs (Project Glasswing, OpenAI Daybreak) the pattern.
8. **The pre‑training pause of mid‑2026**: no Western lab shipped a new frontier *base model* between GPT‑5.6/Fable 5 (June) and late August. Every release in the window — Opus 5, Grok 4.6, Muse Spark 1.2, GLM‑5.3, DeepSeek 0731/0813 — was post‑training on an existing base, often with startling gains (GLM‑5.3 +20pp on DeepSWE from post‑training alone). The next bases are all in the oven: OpenAI **Astra** (named Aug 1), **Gemini 4** (pre‑training confirmed Jul 21), **Grok 5** (~6T, training), Meta's "larger and much more capable models on the way."
9. **AI started producing new mathematics**: OpenAI's Aug 1 Astra announcement claimed **ten new results on long‑standing open problems in mathematics and theoretical CS, each with a machine‑checkable Lean proof** — the first frontier‑model body of formally verified original research, and the clearest capability signal of the period despite no product shipping.
...
_Compiled April 26, 2026; updated July 9, 2026 (May–July release wave: Llama 5, Gemini 3.5 Flash/Omni, Opus 4.8, Fable/Mythos 5, Sonnet 5, Qwen 4, Grok 4 Open/4.5, GPT‑5.6); updated August 23, 2026 (Jul–Aug wave: Kimi K3, Opus 5, Qwen3.8‑Max, Muse Spark 1.2/Muse Code, Grok 4.6, DeepSeek V4 GA, GLM‑5.3; Astra named; Gemini 4 in pre‑training). Treat all undisclosed compute, parameter, and cost figures as approximate; mark them as such when citing._
